...
//        data class TypeNotCopyable(val type: Type): Diagnostic.Kind(Severity.ERROR)
        ...
        data class NotAMatchableType(val type: Type) : Diagnostic.Kind(Severity.ERROR)
        data class NotAnEnumType(val type: Type) : Diagnostic.Kind(Severity.ERROR)
        data class NoSuchCase(val declaration: Declaration.Enum, val name: Name) : Diagnostic.Kind(Severity.ERROR)
