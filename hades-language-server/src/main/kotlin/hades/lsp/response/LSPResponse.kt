package hades.lsp.response


data class LSPResponse(
    val id: Int,
    val params: LSPResponseParams
)

sealed class LSPResponseParams
...
object Shutdown: LSPResponseParams()

data class Hover(val contents: String): LSPResponseParams()
